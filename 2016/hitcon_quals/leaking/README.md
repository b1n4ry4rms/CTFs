...
Так так :), значит все работает и теперь мы можем внедрять код любой длины, не преживая о проверке в 12 символов. Это нас не останавливает теперь.
